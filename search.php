...
<head>
    <title>Search - Capstone Presentations Winter 2022</title> 
                ...
                <ul class="dawgdrops-nav" id="menu-brand-menu">
                    ...
                    <li class="dawgdrops-item">
                        ...
                        <ul class="dawgdrops-menu dawgdrops-menu-em" id="menu-104">
                            <li>
                                <a href="./csse.html"
                                title="CSSE">Computer Science and Software Engineering</a>
                            </li>
                    ...
                    <li class="dawgdrops-item">
                        ...
                        <ul class="dawgdrops-menu dawgdrops-menu-em" id="menu-104">
                            <li>
                                ...
                                title="Electrical Engineering">Electrical & Computer <br/> Engineering</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="dawgdrops-item">
                        <button type="submit"><a href="https://depts.washington.edu/stemadv/winter-2022/search.php"><i class="fa fa-search"></i></a></button>                  
                    </li>
                </ul>
            </div>
        </nav>
        
        <h1>Winter 2022 Capstone & Symposium</h1>
        <h2>March 18, 2022</h2>
        <hr>
    </header>
        ...
        if ($mysqli_connection->connect_error){
            ...
            if ($keywordfromform != '') {
                ...
                if ($search_type == "student-name") {
                    $query_cmd = "SELECT project_id FROM winter2022 WHERE student_name LIKE '%".$keywordfromform."%'";
                } else if ($search_type == "project-title") {
                    $query_cmd = "SELECT project_id FROM winter2022 WHERE project_title LIKE '%".$keywordfromform."%'";
                } else {
                    $query_cmd = "SELECT project_id FROM winter2022 WHERE faculty_advisor LIKE '%".$keywordfromform."%'";
                }
